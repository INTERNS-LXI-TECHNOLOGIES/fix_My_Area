...
export function Navigation() {
  ...
  const navigation = [
    { name: 'Home', href: '/' },
    { name: 'Report Issue', href: '/raise-issue' },
    { name: 'Browse Issues', href: '/issues' },
    { name: 'Dashboard', href: '/authority-kpi-dashboard' },
  ];
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">FMA</span>
              </div>
              <span className="text-xl font-bold text-gray-900">Fix My Area</span>
            </Link>
          </div>
